...
var App = () => {
  ...
  return /* @__PURE__ */ Snapp.create("div", null, /* @__PURE__ */ Snapp.create(Hello, { id: hello }), " 400 ", btn, /* @__PURE__ */ Snapp.create(Div, null, /* @__PURE__ */ Snapp.create(FullButton, null, "Hello Fragment ", chk)));
};
var Div = (props) => {
